...
void __attribute__((picinterrupt(("")))) ADC_ISR(void);
void inicio ( void );
int result;
int adc = 0;
...
void main(void) {
    ...
    while(1){
        if ((result >= 0)&&(result < 205)){
            ...
            PORTBbits.RB4 = 1; PORTBbits.RB5 = 1; PORTBbits.RB6 = 0; PORTBbits.RB7 = 0;
        }
        else if ((result >= 614)&&(result < 818)){

            PORTBbits.RB4 = 1; PORTBbits.RB5 = 1; PORTBbits.RB6 = 1; PORTBbits.RB7 = 0;
        }
...
void __attribute__((picinterrupt(("")))) ADC_INTB0(void){
